...
CASClient::Frameworks::Rails::Filter.configure(
  ...
  :proxy_retrieval_url => "https://pat1.powertochange.org/cas_proxy_callback/retrieve_pgt",
  :proxy_callback_url => "https://pat1.powertochange.org/cas_proxy_callback/receive_pgt",
